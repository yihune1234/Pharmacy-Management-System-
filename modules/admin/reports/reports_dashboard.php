    ...
    <main class="flex-1 overflow-auto ml-72">
        ...
        <header class="h-20 bg-white/70 backdrop-blur border-b border-slate-200/60 flex items-center justify-between px-8 sticky top-0 z-40">
            <div>
                ...
                <h1 class="text-lg font-bold text-slate-800 tracking-tight leading-none">Reports Dashboard</h1>
            </div>
            <div class="flex items-center space-x-3">
                ...
                <button class="bg-slate-900 text-white px-8 py-3.5 rounded-2xl text-sm font-black shadow-xl shadow-slate-200 hover:bg-slate-800 transition-all flex items-center">
        ...
        <div class="p-8">
            ...
            <div class="mb-10">
                ...
                <h1 class="text-4xl font-extrabold text-slate-900 tracking-tight mb-2">Reports Dashboard</h1>
                <p class="text-slate-500 font-medium">Cross-sectional business intelligence and performance matrix.</p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                <div class="bg-white p-10 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/40">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                <a href="sales_report.php" class="group bg-white p-8 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/40 hover:-translate-y-2 transition-all">
                ...
                <a href="stock_report.php" class="group bg-white p-8 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/40 hover:-translate-y-2 transition-all">
                ...
                <a href="../employees/view_new.php" class="group bg-white p-8 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/40 hover:-translate-y-2 transition-all">
